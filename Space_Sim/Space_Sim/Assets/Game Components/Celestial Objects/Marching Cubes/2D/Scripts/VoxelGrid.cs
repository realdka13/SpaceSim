...
public class VoxelGrid : MonoBehaviour
{
    ...
    private Voxels dummyX, dummyY, dummyT;
    ...
    private void CreateVoxel(int i, int x, int y)
    {
        ...
        o.transform.localPosition = new Vector3((x + .5f) * voxelSize, (y + .5f) * voxelSize, -.01f);
        o.transform.localScale = Vector3.one * voxelSize * .1f;
        voxelMaterials[i] = o.GetComponent<MeshRenderer>().material;
        voxels[i] = new Voxels(x, y, voxelSize);
    }
    ...
    private void TriangulateCell(Voxels a, Voxels b, Voxels c, Voxels d)
    {
        int cellType = 0;
		if (a.state)
        {
    ...
    public void Initialize(int resolution, float size)
    {
        ...
        voxels = new Voxels[resolution * resolution];
