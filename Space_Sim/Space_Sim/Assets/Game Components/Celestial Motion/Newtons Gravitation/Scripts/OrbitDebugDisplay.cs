...
public class OrbitDebugDisplay : MonoBehaviour {
    ...
    class VirtualBody {                         //A virtual body to use for the calculations rather than moving the physical body
    ...
    void Start(){if(Application.isPlaying){HideOrbits();}}

    void Update(){if(!Application.isPlaying){DrawOrbits();}}
